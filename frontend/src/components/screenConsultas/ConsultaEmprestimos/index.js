...
import EditEmprestimo from '../../Forms/EditEmprestimo';
import axios from 'axios';

export default function ConsultaEmprestimos(){
    ...
    async function getEmprestimos(){
        const response = await axios.get('http://localhost/reactapp/backend/selects.php?select=emprestimos',{
    ...
    return(
        <div>
            {viewEdit && (
                ...
                <div className='box-load'><EditEmprestimo obj={objEdit} close={closeEdit}/></div>
                </>
                )
            }
            {viewDeletar && (
                ...
                <Deletar id={idDelete} deletar={'emprestimo'} closedelete={closeDelete}/>
                </>                
            )}
            ...
            <thead>
                <tr>
                    ...
                    <th> Usuário fez o Empréstimo </th>
                    <th> Concluído </th>
                    <th> Editar </th>
                    <th> Excluir </th>
                </tr>
